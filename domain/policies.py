...
KEY_PRIORITY_SORT = "bubble.priority_sort"  # '0' | '1' 중요도 높은순 정렬 마지막 상태
...
KEY_IDLE_ENABLED = "character.idle_enabled"        # '0' | '1' — 비활성 이미지 사용 여부
KEY_IDLE_HOURS = "character.idle_hours"            # 비활성 판정 기준 시간
...
KEY_OVERDUE_IMAGE_ENABLED = "character.overdue_image_enabled"  # '0' | '1' — 밀린할일 이미지 알림 사용 여부
KEY_OVERDUE_IMAGE_SCHEDULE = "character.overdue_image_schedule"  # 'hourly_top' | 'hourly_half' | 'three_times'
KEY_OVERDUE_IMAGE_DURATION_PRESET = "character.overdue_image_duration_preset"  # 'short' | 'normal' | 'long'
KEY_OVERDUE_IMAGE_INTERVAL_MINUTES = "character.overdue_image_interval_minutes"  # 밀린할일 이미지 재표시 간격(분)
KEY_OVERDUE_IMAGE_DURATION_MINUTES = "character.overdue_image_duration_minutes"  # 밀린할일 이미지 1회 표시 시간(분)
KEY_OVERDUE_IMAGE_LAST_SHOWN = "character.overdue_image_last_shown"  # 밀린할일 이미지 마지막 표시 시각(epoch seconds)
KEY_CLIPBOARD_SPLIT_LINES = "todo.clipboard_split_lines"  # 붙여넣기 시 줄 단위로 할일 분할
KEY_SOUND_ENABLED = "character.sound_enabled"  # '0' | '1' — 상황별 사운드 전체 사용 여부
KEY_SOUND_VOLUME = "character.sound_volume"    # 상황별 사운드 전체 음량(0~100)
KEY_SOUND_OVERDUE = "character.sound_overdue"
KEY_SOUND_DELETE = "character.sound_delete"
KEY_SOUND_IDLE = "character.sound_idle"
KEY_SOUND_DONE = "character.sound_done"
KEY_SOUND_ADD = "character.sound_add"
KEY_SOUND_WORK = "character.sound_work"
KEY_SOUND_PAUSE = "character.sound_pause"
KEY_SOUND_TIMER_DONE = "character.sound_timer_done"
KEY_SOUND_OPEN = "character.sound_open"
KEY_SOUND_CLOSED = "character.sound_closed"
KEY_SOUND_OVERDUE_VOLUME = "character.sound_overdue_volume"
KEY_SOUND_DELETE_VOLUME = "character.sound_delete_volume"
KEY_SOUND_IDLE_VOLUME = "character.sound_idle_volume"
KEY_SOUND_DONE_VOLUME = "character.sound_done_volume"
KEY_SOUND_ADD_VOLUME = "character.sound_add_volume"
KEY_SOUND_WORK_VOLUME = "character.sound_work_volume"
KEY_SOUND_PAUSE_VOLUME = "character.sound_pause_volume"
KEY_SOUND_TIMER_DONE_VOLUME = "character.sound_timer_done_volume"
KEY_SOUND_OPEN_VOLUME = "character.sound_open_volume"
KEY_SOUND_CLOSED_VOLUME = "character.sound_closed_volume"
KEY_SOUND_OVERDUE_MODE = "character.sound_overdue_mode"  # 'once' | 'loop'
KEY_SOUND_DELETE_MODE = "character.sound_delete_mode"
KEY_SOUND_IDLE_MODE = "character.sound_idle_mode"
KEY_SOUND_DONE_MODE = "character.sound_done_mode"
KEY_SOUND_ADD_MODE = "character.sound_add_mode"
KEY_SOUND_WORK_MODE = "character.sound_work_mode"
KEY_SOUND_PAUSE_MODE = "character.sound_pause_mode"
KEY_SOUND_TIMER_DONE_MODE = "character.sound_timer_done_mode"
KEY_SOUND_OPEN_MODE = "character.sound_open_mode"
KEY_SOUND_CLOSED_MODE = "character.sound_closed_mode"
